...
impl AppState {
    ...
    pub fn update_bootstrap_step(&self, step: BootstrapStepUpdate) {
        ...
        progress.current_step = step.step.into();
        progress.message = step.message;
        progress.current_step_eta_seconds = step.eta_seconds;
        progress.overall_percent = step.percent;
    }
    ...
    pub fn mark_bootstrap_failed<S: Into<String>>(&self, message: S) {
        ...
        *progress = BootstrapProgress {
            ...
            current_step_eta_seconds: 0,
            overall_percent: progress.overall_percent.max(1),
        };
    }
...
mod tests {
    ...
    use super::{
        lifetime_token_milestones_crossed, parse_headroom_stats_from_json, AppState,
